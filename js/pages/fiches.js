...
const FICHE_MODULES = {
  ...
  PC_MEC:    () => import('../../data/fiches/pc_mecanique.js'),
  PC_THERMO: () => import('../../data/fiches/pc_thermodynamique.js'),
  PC_ELEC:   () => import('../../data/fiches/pc_electricite.js'),
  PC_OPT:    () => import('../../data/fiches/pc_optique.js'),
  PC_CHIM:   () => import('../../data/fiches/pc_chimie.js'),
